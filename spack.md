...
<table class="status_table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="na" style="text-align: center" markdown="span">([🔎](#diy))</td><!-- CPU -->
...
<span id="adios2_rocm">**ADIOS2**</span> - ADIOS2 ROCm/HIP support is not expected in the near-term release.
